...
from torch import Tensor, allclose, linspace, ones, randn
...
def test_manual_forward_laplacian(
    ...
    coefficients_fn: Callable[[Tensor, Union[None, List[int]]], Union[None, Tensor]],
):
    ...
    true_laplacian_X = (
        einsum(true_hessian_X, "batch d d -> ")
        if coefficients is None
        else einsum(true_hessian_X, coefficients, "batch i j, i j -> ")
    )
