...
sweep_ids = {  # ids from the wandb agent
    "q62f6mwv": "SGD",
    "p9g8fym5": "Adam",
    "plpfwnsc": "Hessian-free",
    "pt5repaa": "LBFGS",
    "py7nkeqf": "ENGD (full)",
    "c1mkjqnb": "ENGD (layer-wise)",
    "ch8r7e58": "ENGD (diagonal)",
    "btjr70du": "KFAC",
    "s0cc3fwk": "KFAC (empirical)",
    "4zk7xnuv": "KFAC (forward-only)",
}
...
if __name__ == "__main__":
    ...
    for metric, ylabel in metric_to_ylabel.items():
        with plt.rc_context(
            ...
            ax.legend()
            plt.savefig(
                path.join(HEREDIR, f"poisson5d_{metric}.pdf"), bbox_inches="tight"
            )
