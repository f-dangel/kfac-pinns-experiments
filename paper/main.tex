...
Recently, second-order methods like natural gradients and Gauss-Newton methods have shown promising performance improving the accuracy by several orders of magnitude over first-order optimizers. 
