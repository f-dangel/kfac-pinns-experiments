...
\subsection{Kronecker-factored approximations for the Poisson equation}\label{sec:KFAC-Laplace}
...
\todo{probably makes sense to combine}
...
The momentum parameter is tuned manually\todo{?} in our experiments via random search.
