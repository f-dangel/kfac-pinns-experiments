...
\begin{figure}
    ...
    \caption{We report the performance of different optimizers on the heat equation~\eqref{eq:1D-Heat} measured in relative $L^2$ error against wall clock time for architectures with different parameter dimensions $D$; }
    \label{fig:1D-heat}
\end{figure}


\subsection{A higher-dimensional problems}


\begin{itemize}
    \item 5D Poisson, formulate in general dimensions 
    \item 10D heat 
    \item 4D heat equation 
\end{itemize}
