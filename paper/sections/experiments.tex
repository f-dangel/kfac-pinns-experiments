...
To test KFAC on a high-dimensional PDE, we consider the Poisson equation used by~\cite{yu2018deep} to evalute the performance of the deep Ritz method, which is given by\todo{5d is cos sum solution, 10d is weinan product solution, only 100d is norm squared} 
