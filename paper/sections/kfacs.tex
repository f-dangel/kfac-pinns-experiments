...
Here, we provide the derivation of the general Kronecker-factored approximation of the Gauss-Newton matrix.
...
\end{align*}
This approximation agrees with the \emph{reduce} setting described in~\citet{eschenhagen2023kroneckerfactored}.
